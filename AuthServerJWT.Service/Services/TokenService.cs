...
namespace AuthServerJWT.Service.Services
{
    public class TokenService : ITokenService
    {
        ...
        private readonly CustumTokenOption _tokenOption;
        public TokenService(UserManager<UserApp> userManager, IOptions<CustumTokenOption> options)
        {
        ...
        {
            var accessTokenExpiration = DateTime.Now.AddMinutes(_tokenOption.AccessTokenExpiraation);
            var refreshTokenExpiration = DateTime.Now.AddMinutes(_tokenOption.RefreshTokenExpiraation);
